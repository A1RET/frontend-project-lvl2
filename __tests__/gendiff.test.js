...
test.each([['before_recursive.json', 'after_recursive.json', 'result_recursive.txt'], ['before_plain.yml', 'after_plain.yml', 'result_plain.txt'], ['before_plain.ini', 'after_plain.ini', 'result_plain.txt']])('gendiff', (before, after, expected) => {
